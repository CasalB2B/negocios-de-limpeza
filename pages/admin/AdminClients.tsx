    ...
    <Layout role={UserRole.ADMIN}>
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
           <div>
              <h1 className="text-3xl font-display font-bold text-darkText dark:text-darkTextPrimary">Clientes</h1>
              <p className="text-lightText dark:text-darkTextSecondary mt-1">Gerencie a base de clientes da plataforma.</p>
           </div>
